...
def main(args=None):
    ...
    splintered_reality = MultiSplinteredReality(
        jobs=[
            ...
            "jobs.tests.real_left_controller_switch_test_job.Move",
            "jobs.tests.real_dual_controller_switch_only_test_job.Move",
            "jobs.tests.real_left_controller_right_toggle_test_job.Move",
